...
(function() {
    ...
    const craftedItems = [
        {item: 'Butter', keepAmt: 6, sellMin: 10},
        {item: 'Eggs', keepAmt: 6, sellMin: 10},
        {item: 'Cake', keepAmt: 0, sellMin: 10},
        {item: 'Wheat', keepAmt: 10, sellMin: 10},
        {item: 'Sugar', keepAmt: 0, sellMin: 10},
        {item: 'Sugarcane', keepAmt: 10, sellMin: 10},
        {item: 'Flour', keepAmt: 0, sellMin: 10},
        {item: 'Salt', keepAmt: 10, sellMin: 10},
        {item: 'Brine', keepAmt: 10, sellMin: 10},
      //  {item: 'Wool_Yarn', keepAmt: 3, sellMin: 10},
     //   {item: 'Cotton_Yarn', keepAmt: 3, sellMin: 10},
